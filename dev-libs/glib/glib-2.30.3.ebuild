...
LICENSE="LGPL-2"
SLOT="2"
IUSE="debug doc fam selinux +static-libs systemtap test utils xattr maemo"
...
#	epatch "${FILESDIR}/${PN}-2.18.1-workaround-gio-test-failure-without-userpriv.patch"
	...
	# Enable maemo changes
	use maemo && epatch "${FILESDIR}/${PN}-2.30.3-maemo-changes.patch"
...
src_configure() {
	...
	use debug && myconf="--enable-debug"
        use maemo && myconf="--enable-maemo=yes"
