...
inherit autotools libtool eutils flag-o-matic gnome2-utils multilib pax-utils python toolchain-funcs virtualx linux-info git-2
...
EGIT_REPO_URI="https://github.com/Cordia/glib.git"
EGIT_SOURCEDIR="${S}"
EGIT_BRANCH="2-32"
