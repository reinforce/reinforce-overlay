...
# $Header: /var/cvsroot/gentoo-x86/net-misc/dhcp/dhcp-4.2.5_p1-r2.ebuild,v 1.6 2014/04/06 14:43:32 vapier Exp $
...
src_prepare() {
	...
	# Enable dhclient to use ppp connection
	epatch "${FILESDIR}"/${PN}-4.1.1-dhclient-ppp.patch
