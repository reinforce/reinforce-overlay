...
inherit eutils multilib autotools toolchain-funcs flag-o-matic git-2 

DESCRIPTION="VLC media player - Video player and streamer"
HOMEPAGE="http://www.videolan.org/vlc/"

EGIT_BOOTSTRAP="bootstrap"
EGIT_REPO_URI="git://github.com/willswang/vlc.git"
...
IUSE="a52 aac aalib alsa altivec atmo +audioqueue avahi +avcodec
	+avformat bidi bluray cdda cddb cedar dbus dc1394 debug dirac direct2d
	directfb directx dshow dts dvb +dvbpsi dvd dxva2 elibc_glibc egl +encode
	fluidsynth +ffmpeg flac fontconfig +gcrypt gme gnome gnutls
	growl httpd ios-vout jack kate kde libass libcaca libnotify
